...
import 'package:loveria/screens/userInformationForReg/user_information_for_reg.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: <String, WidgetBuilder>{
          ...
          "/user_information_for_reg": (BuildContext context) =>
               const UserInformationForReg(),
        });
  }
}
